...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    // Following 2 precedence declarations resolve ID : TYPE <- expression.ID(...)
    ...
    */
    ...
    nested_let : OBJECTID ':' TYPEID ASSIGN expression ',' nested_let
    { $$ = let($1, $3, $5, $7); }
    ...
    { $$ = dispatch(object(idtable.add_string("self")), $1, $3); } // NOTE self SYMBOL CREATION, NOT SURE IF IT WORKS
